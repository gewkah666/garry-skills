...
See `references/speech-tts-quickstart.md` for the verified TTS recipe
(model variants, Chinese voice IDs, install steps, pitfalls).
...
**For Chinese TTS recipes, model variants, voice IDs, and verified pitfalls, see `references/speech-tts-quickstart.md`.**
...
| `--mood <text>` | string | Mood description, e.g. warm, melancholic, uplifting |
...
| `--audio-file <path>` | string | Local reference audio (auto base64-encoded) |
